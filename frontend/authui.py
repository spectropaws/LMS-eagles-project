...
username_frame.pack(pady=(40, 10))
...
password_field = Entry(password_frame, font=("Arial", 16))
password_field.pack(padx=20)

submit_button = Button(app, text="Login", font=("Arial", 16), compound=CENTER, fg="white", bg="blue", height=2, width=10, padx=15, pady=5, border=0)
